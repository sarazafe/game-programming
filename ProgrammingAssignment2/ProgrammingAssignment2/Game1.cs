...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            otter1 = Content.Load<Texture2D>(@"images\otter1");
            otter2 = Content.Load<Texture2D>(@"images\otter2");
            otter3 = Content.Load<Texture2D>(@"images\otter3");

            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = otter1;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > ChangeDelayTime)
            {
                ...
                {
                    currentSprite = otter2;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = otter3;
                }
