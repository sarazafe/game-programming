...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D spriteRock1;
        Texture2D spriteRock2;
        Texture2D spriteRock3;
        ...
        protected override void LoadContent()
        {
            ...
            spriteRock1 = Content.Load<Texture2D>(@"images/greenrock");
            spriteRock2 = Content.Load<Texture2D>(@"images/magentarock");
            spriteRock3 = Content.Load<Texture2D>(@"images/whiterock");
